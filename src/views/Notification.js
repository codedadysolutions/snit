      ...
      <View style={styles.mainContainer}>
        ...
        <View style={{flex:1, marginTop: 20}}>
            ...
            <View style={{justifyContent: 'center', alignItems:'center', }}>
                <NotificationComp assign={true} onPressReject={()=>console.warn('reject')} onPressAccept={()=>console.warn('accept')} />
                <NotificationComp assign={false} onPressReject={()=>console.warn('reject')} onPressAccept={()=>console.warn('accept')} />
            </View>
